...
const athlete_img = fs.readFileSync(`./src/utils/nfl-svg-teams-animation-templates/ATL.svg`, "utf-8")
...
console.log(result.svg.g[5].text[4].tspan["_cdata"])
console.log(result.svg.g[5].text[5].tspan["_cdata"])
