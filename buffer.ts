...
const athlete_img = fs.readFileSync(`./src/utils/nfl-svg-teams-animation-templates/NYJ_Animation.svg`, "utf-8")
...
console.log(result.svg.g[4].text)
result.svg.g[4].text[0].tspan["_cdata"] = "69"
result.svg.g[4].text[1].tspan["_cdata"] = "69"
result.svg.g[4].text[2].tspan["_cdata"] = "SP"
result.svg.g[4].text[3].tspan["_cdata"] = "SP"
result.svg.g[4].text[4].tspan["_cdata"] = "VINCE"
result.svg.g[4].text[5].tspan["_cdata"] = "VINCE"
result.svg.g[4].text[6].tspan["_cdata"] = "GONZALES"
result.svg.g[4].text[7].tspan["_cdata"] = "GONZALES"
